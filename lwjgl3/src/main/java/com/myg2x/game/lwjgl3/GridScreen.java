...
public class GridScreen extends Scene {
    ...
    private void draw() {
        try {
            ...
            // NEW: Render the inventory bar at the bottom.
            game.inventoryBar.render();
            batch.end();
    ...
    @Override
    public void dispose() {
        try { batch.dispose(); } catch (Exception e) { System.err.println("Error disposing batch: " + e.getMessage()); }
        try { shape.dispose(); } catch (Exception e) { System.err.println("Error disposing shape: " + e.getMessage()); }
        try { circleImage.dispose(); } catch (Exception e) { System.err.println("Error disposing circleImage: " + e.getMessage()); }
        try { audioManager.dispose(); } catch (Exception e) { System.err.println("Error disposing audioManager: " + e.getMessage()); }
        try { mathAtlas.dispose(); } catch (Exception e) { System.err.println("Error disposing mathAtlas: " + e.getMessage()); }
    }
}
